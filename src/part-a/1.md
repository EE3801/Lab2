...
Set the default startup directory in the Preferences window (click the  icon in the toolbar) so you do not have to change directories each time you start Spyder:

![Alt text](SpyderDirectory.png)
