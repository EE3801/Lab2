...
> <p class="note">Note
> 
> Windows users should enter the commands below using the Anaconda Prompt, which should have been added when you installed MiniConda or Anaconda.
> 
...
- [pyedfread](https://github.com/s-ccs/pyedfread)
