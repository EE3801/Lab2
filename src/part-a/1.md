...
> (aws) $ cd ..
> ```
> your `PanGUI`, `PyHipp`, and `pyedfread` folder must exist in the same folder as your DataProcessingTools. In the example below, that would be the `Documents/EE3801` folder or else your command will fail.
